...
<body>
  ...
  <div class="container">
        <table  style="margin-top: 2rem;" class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="table-secondary"><img src='{{asset("storage/image/" .$pengaduan->foto)}}'width="150px" heigth="150px"></td>
        ...
        <a href="{{'isi-pengaduan'}}" type="submit" class="btn btn-success" style="heigth:150px;width:150px;margin-top:1rem;">Buat Pengaduan</a>
  </div>
</body>
</html>