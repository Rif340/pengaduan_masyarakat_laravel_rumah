...
<body>
    ...
    <section class="text-center text-lg-start">
        ...
        <nav class="navbar fixed-top" style="background-color: #563d7c; backdrop-filter: blur(10px);">
                        ...
                        <div class="card-body p-5 shadow-5 text-center">
                            ...
                            <form action="{{'register'}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <input id="input" type="text" id="form3Example2" class="form-control" name="password">
                                ...
                                <div class="form-outline mb-4">
                                    <input id="input" type="password" id="form3Example4" class="form-control" name="telepon">
